...
- Write global project documents
- Define positioning and target audience
- Set initial design direction
- Create folders for website, resume, works, and assets

## V0.2 - Portfolio Website MVP
...
- Add final resume PDF
- Add real project links or prototype links
- Deploy the website
- Bind custom domain
